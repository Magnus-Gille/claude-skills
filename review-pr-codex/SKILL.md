...
```bash
script -q /dev/null codex exec --sandbox workspace-write --skip-git-repo-check -m gpt-5.4 -c model_reasoning_effort='"xhigh"' "You are a senior code reviewer performing a thorough review of a pull request.
